#ifndef DOUBLE_HANDSHAKE_EXAMPLE_INCLUDED
#define DOUBLE_HANDSHAKE_EXAMPLE_INCLUDED
...
{
  osss::osss_port<osss::osss_sender_if<unsigned int> > ch_out;
  ...
  virtual void main()
  {
    ...
    {
      OSSS_PRINT_TIME_STAMP_WITH_TEXT("send data: " << i);
      ch_out->send(i);
    }
  }
...
{
  osss::osss_port<osss::osss_receiver_if<unsigned int> > ch_in; 
  ...
  virtual void main()
  {
    ...
    {
      ch_in->receive(data);
      OSSS_PRINT_TIME_STAMP_WITH_TEXT("received data: " << data);
    }
  }
...
OSSS_BEHAVIOUR(B_par)
{
  ...
  osss::osss_double_handshake_channel<unsigned int> ch;
