...
#ifndef OSSS_TRANSCEIVER_IF_INCLUDE
#define OSSS_TRANSCEIVER_IF_INCLUDE


#include "osss_sender_if.h"
#include "osss_receiver_if.h"

namespace osss {

template<typename T>
class osss_transceiver_if : 
  public virtual osss_sender_if<T>,
  public virtual osss_receiver_if<T>
{
 public:
  osss_transceiver_if() {}
  virtual ~osss_transceiver_if() {}
};
